                ...
                <div className='col-lg-6 mx-auto'>
                    <div className='alert-inner p-4 p-lg-5 bg-dark rounded shadow'>
                        ...
                        <p className='fw-light text-muted mb-0'>
                            Our contracts are deployed to <span className='text-white text-capitalize'>CoinEx Smart Chain (CSC)</span>{' '}
                            network, but The network you're connected to is{' '}
                            <span className='text-white text-capitalize'>{networkName}</span>. Connect to CSC network
                            and try again.
                        </p>
                    </div>
                </div>
