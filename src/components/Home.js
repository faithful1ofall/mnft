...
function Home({ topSellers }) {
    ...
    useEffect(() => {
        document.title = 'Mini Utopia NFT Marketplace';
    });
                    ...
                    <div className='row gy-4'>
                            ...
                            <div className='card card-hover-minimal shadow bg-body htw-card' >
                                <div className='card-body p-lg-5 d-flex align-items-center'>
                                    <div className=' mx-auto flex-shrink-0'  >
                                        <a href='https://www.coinex.net/token/0xD482E9FC49fA4D5cD2229FC4c443c7F77B68c518'>
                                            <img className='img-fluid' src='images/coinex_smart_chain_white.svg' alt='coinExSmartChain' /> 
                                        </a>
                                    </div>
                        ...
                        <div className='col-lg-4'>
                            <div className='card card-hover-minimal shadow bg-body htw-card' >
                                <div className='card-body p-lg-5 d-flex align-items-center'>
                                    <div className=' mx-auto flex-shrink-0'  >
                                        <a href='https://www.oneswap.net/cet/trade/0xaC72c23cB2c8A25F85989585fED913334bDe1297'>
                                            <img className='img-fluid' src='images/oneswap.svg' alt='OneSwap' /> 
                                        </a>
                                    </div>
